export const en = {
    ...
    pages: {
        ...
        contents: {
            ...
            "delete-selected-info": "Are you sure you want to remove selected contents (IDs: {itemId})?",
            "delete-selected-single-info": "Are you sure you want to remove selected content (ID: {itemId})?",
