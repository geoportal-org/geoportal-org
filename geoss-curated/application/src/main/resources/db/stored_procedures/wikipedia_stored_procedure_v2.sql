...
BEGIN
    ...
    START TRANSACTION;
		...
		-- Insert entry
		INSERT INTO entry(title, summary, logo, keywords, tags, code, typeId, sourceId, dataSourceId, displayDataSourceId)
		VALUES(_title, _summary, _logo, _keywords, _tags, _code, _typeId, _sourceId, _dataSourceId, dataSourceId)
		ON DUPLICATE KEY UPDATE title=_title, summary=_summary, logo=_logo, keywords=_keywords, tags=_tags, code=_code, typeId=_typeId, sourceId=_sourceId, dataSourceId=_dataSourceId, displayDataSourceId=_dataSourceId;
