...
BEGIN
    ...
    START TRANSACTION;
		...
		-- Insert entry
		INSERT INTO entry(title, summary, logo, keywords, tags, code, typeId, definitionTypeId, sourceId, dataSourceId, displayDataSourceId)
		VALUES(_title, _summary, _logo, _keywords, _tags, _code, _typeId, _definitionTypeId, _sourceId, _dataSourceId, dataSourceId)
		ON DUPLICATE KEY UPDATE title=_title, summary=_summary, logo=_logo, keywords=_keywords, tags=_tags, code=_code, typeId=_typeId, definitionTypeId=_definitionTypeId, sourceId=_sourceId, dataSourceId=_dataSourceId, displayDataSourceId=_dataSourceId;
