...
const NavMobile = () => {
    ...
    return (
        ...
        >
            <Link href="/">
                <Image alt="geoss-logo" width={150} height={30} src={"/portalLogo.webp"} />
            </Link>
            <button className="hover:scale-105" onClick={() => setBurgerMenuOpen(true)}>
            ...
            {burgerMenuOpen && (
                <div className="scrollbar flex flex-col items-center justify-between z-30 fixed bottom-0 top-0 w-full overflow-y-scroll bg-white">
                    <div className="w-full flex items-center min-h-[48px] pl-4 mb-2">
                        ...
                        <button className="ml-auto" onClick={() => setBurgerMenuOpen(false)}>
                            <CrossIcon className="hover:scale-125" width="2em" height="2em" />
                        </button>
                    </div>
                    <nav className="relative flex w-full px-4">
                        <ul className="flex flex-col items-center w-full h-full divide-y">
                            ...
                            <li className="w-full py-4">
                                <Accordion options={providersOptions} text="Data providers" />
                            </li>
                            <li className="w-full py-4">
                    ...
                    <div className="relative flex flex-row items-center justify-around w-full mt-auto py-4">
                        ...
                        <Image alt="UE flag image" width={50} height={30} src={uniFlagImage} />
                    </div>
                </div>
            )}
        </div>
