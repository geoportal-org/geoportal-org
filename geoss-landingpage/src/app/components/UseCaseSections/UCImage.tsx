...
const UCImage = ({
  ...
  return (
    <section
      className={`w-full px-6 lg:px-48 py-20 lg:py-24 ${
        isDarkBg && "bg-[#F2F5F7]"
      }`}
    >
      <div
        className={`w-full flex flex-col xl:flex-row justify-between gap-12 xl:gap-32`}
      >
        <div
          id="text"
        ...
        <div
          id="image"
          className={`w-full my-auto flex ${side === "left" && "order-1"}`}
        >
          <Image
            priority
            loading="eager"
