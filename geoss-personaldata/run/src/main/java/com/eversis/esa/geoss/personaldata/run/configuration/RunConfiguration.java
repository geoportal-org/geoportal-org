 ...
 */
@Log4j2
@EnableJpaRepositories(basePackages = "com.eversis.esa.geoss.personaldata.run.repository")
@ComponentScan(
        basePackages = {
                "com.eversis.esa.geoss.personaldata.run.event"
        }
)
...
public class RunConfiguration {
    ...
    /**
     * Run open api customizer open api customizer.
     *
     * @return the open api customizer
     */
    @Bean
    OpenApiCustomizer runOpenApiCustomizer() {
        return openApi -> {
