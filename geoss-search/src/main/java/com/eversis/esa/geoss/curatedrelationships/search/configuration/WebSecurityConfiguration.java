...
import com.eversis.esa.geoss.curatedrelationships.search.configuration.oauth2.SecurityOauth2Properties;
...
public class WebSecurityConfiguration {
    ...
    /**
     * Opensearch security filter chain security filter chain.
     *
     * @param http the http
     * @return the security filter chain
     * @throws Exception the exception
    ...
    @Bean
    @Order(SecurityProperties.DEFAULT_FILTER_ORDER)
    SecurityFilterChain opensearchSecurityFilterChain(HttpSecurity http) throws Exception {
        http.securityMatcher("/opensearch");
        http.authorizeHttpRequests(
                authorizationManagerRequestMatcherRegistry -> authorizationManagerRequestMatcherRegistry
                        .requestMatchers("/opensearch").permitAll());
        return http.build();
    }
    ...
    SecurityFilterChain apiSecurityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(authorizationManagerRequestMatcherRegistry -> {
            authorizationManagerRequestMatcherRegistry
                    .requestMatchers(basePath + "/concepts/**")
                    .permitAll();
            authorizationManagerRequestMatcherRegistry
                    .requestMatchers(basePath + "/extensions/**")
                    .permitAll();
            authorizationManagerRequestMatcherRegistry
