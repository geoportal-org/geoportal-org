...
/**
 * The type Entry response mapper.
 */
@Component
public class EntryResponseMapper extends BaseElasticsearchResponseMapper<Entry> implements
        FacetedElasticsearchResponseMapper<Entry> {

    private final AggregationsMapper aggregationsMapper;

    /**
     * Instantiates a new Entry response mapper.
     *
     * @param documentMapper the document mapper
     * @param aggregationsMapper the aggregations mapper
     */
    public EntryResponseMapper(ElasticsearchDocumentMapper<Entry> documentMapper,
            AggregationsMapper aggregationsMapper) {
