...
const Transition = {
	...
	afterEnter(el: any) {
		...
		el.style.height = '';
		el.style.overflow = Transition.transitionForceVisible ? 'visible' : el.dataset.oldOverflow;
	...
	beforeLeave(el: any) {
		...
		el.dataset.oldPaddingTop = el.style.paddingTop;
		el.dataset.oldPaddingBottom = el.style.paddingBottom;
		el.dataset.oldOverflow = Transition.transitionForceVisible ? 'visible' : el.style.overflow;
