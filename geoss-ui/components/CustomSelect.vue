<template>
	<div class="custom-select">
		...
		<div class="custom-select__icons">
			<button v-if="options.length" @click="clear()" class="custom-select__clear cross" :aria-label="$t('generalFilters.cancel')" v-show="clearable && ((value && !multiple) || (multiple && value.length))"></button>
