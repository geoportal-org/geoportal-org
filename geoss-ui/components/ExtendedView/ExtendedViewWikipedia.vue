<template>
    <div class="ev-wikipedia">
        <div v-if="result" class="ev-wikipedia__wrapper">
            <div class="ev-wikipedia__image"
                :class="{ 'ev-wikipedia__image--default': (getImage(result.logo) !== result.logo) }">
            ...
            <div class="d-flex flex--column flex--1 padding-right-25">
                ...
                <div class="d-flex">
                    <button @click="showDetails()" class="ev-wikipedia__more">
                        <span>{{ $tc('dabResult.seeOnWikipedia') }}</span>
...
.ev-wikipedia {
    ...
    &__placeholder {
        background: url('/svg/wikipedia-placeholder.svg') center center / cover no-repeat;
        display: flex;
        height: 100%;
    }
