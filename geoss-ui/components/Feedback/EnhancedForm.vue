			...
			<div class="form__wrapper">
				<div class="form__header">
					<img
						...
						class="form__logo"
					/>
					<h2 class="form__title">{{ $tc('feedback.enhancedForm.title') }}</h2>
				</div>
					...
					>
						<slide :class="{ 'VueCarousel-slide-active': initialLoad }">
							<h3 class="form__subtitle-enhanced uppercase">
								{{ $tc('feedback.enhancedForm.introduction') }}
							</h3>
							<div class="slide-content">
								<div class="form__text-content">
									<span class="text-bold">{{
										$tc('feedback.enhancedForm.interface')
									}}</span>
									<img
										:src="`/img/geoss-portal-interface.png`"
										alt="GEOSS Portal interface"
										class="form__interface"
									/>
									<span class="text-bold">{{
										$tc('feedback.enhancedForm.page1.title')
									}}</span>
									<p class="form__text-content-paragraph">
										{{ $tc('feedback.enhancedForm.page1.description') }}
									</p>

									<p class="form__text-content-paragraph">
										{{ $tc('feedback.enhancedForm.page1.descriptionCd') }}
									</p>

									<ul class="form__text-content-list">
										<li>{{ $tc('feedback.enhancedForm.page1.li1') }}</li>
										<li>{{ $tc('feedback.enhancedForm.page1.li2') }}</li>
										<li>{{ $tc('feedback.enhancedForm.page1.li3') }}</li>
									</ul>

									<span class="text-bold">{{
										$tc('feedback.enhancedForm.page1.questionnaireHas')
									}}</span>

									<ul class="form__text-content-list">
										<li>{{ $tc('feedback.enhancedForm.page1.li4') }}</li>
										<li>{{ $tc('feedback.enhancedForm.page1.li5') }}</li>
										<li>{{ $tc('feedback.enhancedForm.page1.li6') }}</li>
									</ul>

									<span class="text-bold">{{
										$tc('feedback.enhancedForm.page1.measure')
									}}</span>

									<ul class="form__text-content-list">
										<li>{{ $tc('feedback.enhancedForm.page1.li7') }}</li>
										<li>{{ $tc('feedback.enhancedForm.page1.li8') }}</li>
										<li>{{ $tc('feedback.enhancedForm.page1.li9') }}</li>
									</ul>

									<p class="form__text-content-paragraph">
										{{ $tc('feedback.enhancedForm.page1.qShouldBe') }}
									</p>

									<p class="form__text-content-paragraph">
										{{ $tc('feedback.enhancedForm.page1.estimate') }}
									</p>

									<p class="form__text-content-paragraph">
										{{ $tc('feedback.enhancedForm.page1.thankYou') }}
									</p>
							...
							<div class="slide-content">
								<div class="form__questions">
									<h3 class="form__questions-title">
										{{ $tc('feedback.enhancedForm.page2.title') }}
									</h3>
									<p class="form__questions-description">
										{{ $tc('feedback.enhancedForm.page2.description') }}
									</p>
								</div>

								<label for="interest" class="form__controls-question">
									{{ $tc('feedback.enhancedForm.page2.interest.label') }}
								</label>
								...
								<label for="classify" class="form__controls-question">
									{{ $tc('feedback.enhancedForm.page2.classify.label') }}
								</label>
								...
								<label for="communityOfPractice" class="form__controls-question not-required">
									{{
										$tc('feedback.enhancedForm.page2.communityOfPractice.label')
									}}
								</label>
								<input
									type="text"
								...
								<label for="applicationInterests" class="form__controls-question">
									{{
										$tc('feedback.enhancedForm.page2.applicationInterests.label')
									}}
								</label>
								...
								<label for="visited" class="form__controls-question">
									{{ $tc('feedback.enhancedForm.page2.visited.label') }}
								</label>
								...
								<label for="used" class="form__controls-question">
									{{ $tc('feedback.enhancedForm.page2.used.label') }}
								</label>
								...
								<label for="specify" class="form__controls-question not-required">
									{{ $tc('feedback.enhancedForm.page2.specify.label') }}
								</label>
								<input
									type="text"
									class="form__controls-text-input"
						...
						<slide>
							<div class="slide-content">
								<div class="form__questions">
									<h3 class="form__questions-title">
										{{ $tc('feedback.enhancedForm.page3.title') }}
									</h3>
									<p class="form__questions-description">
										{{ $tc('feedback.enhancedForm.page3.description') }}
									</p>
								</div>

								<label for="2.1" class="form__controls-question not-required">
									{{ $tc('feedback.enhancedForm.page3.goTo.label') }}
								</label>
								...
								<label for="tryToLocate" class="form__controls-question">
									{{ $tc('feedback.enhancedForm.page3.tryToLocate.label') }}
								</label>
								...
								<label for="ifYouHaveTime" class="form__controls-question not-required">
									{{ $tc('feedback.enhancedForm.page3.ifYouHaveTime.label') }}
								</label>
								...
								<label for="didYouFind" class="form__controls-question">
									{{ $tc('feedback.enhancedForm.page3.didYouFind.label') }}
								</label>
								...
								<label for="howManyResources" class="form__controls-question">
									{{ $tc('feedback.enhancedForm.page3.howManyResources.label') }}
								</label>
								<input
									type="text"
									class="form__controls-text-input"
								...
								<label for="withReference" class="form__controls-question">
									{{ $tc('feedback.enhancedForm.page3.withReference.label') }}
								</label>
								<input
									type="text"
									class="form__controls-text-input"
								...
								<label for="howManyResults" class="form__controls-question">
									{{ $tc('feedback.enhancedForm.page3.howManyResults.label') }}
								</label>
								<input
									type="text"
									class="form__controls-text-input"
								...
								<label for="succeedInDownloading" class="form__controls-question">
									{{
										$tc('feedback.enhancedForm.page3.succedInDownloading.label')
									}}
								</label>
								...
								<label for="tellUsAbout" class="form__controls-question not-required">
									{{ $tc('feedback.enhancedForm.page3.tellUsAbout.label') }}
								</label>
								<input
									type="text"
									class="form__controls-text-input"
								...
								<label for="2.9" class="form__controls-question not-required">
									{{ $tc('feedback.enhancedForm.page3.goBack.label') }}
								</label>
								...
								<label for="tryToSignIn" class="form__controls-question">
									{{ $tc('feedback.enhancedForm.page3.tryToSignIn.label') }}
								</label>
								<div>
									<label
										class="form__controls-label"
								...
								<label for="multiSearch" class="form__controls-question">
									{{ $tc('feedback.enhancedForm.page3.multiSearch.label') }}
								</label>
								<div>
									<label
										class="form__controls-label"
								...
								<label for="tryToBookmark" class="form__controls-question not-required">
									{{ $tc('feedback.enhancedForm.page3.tryToBookmark.label') }}
								</label>
								<div>
									<label
										class="form__controls-label"
								...
								<label for="lookToWorkspace" class="form__controls-question not-required">
									{{ $tc('feedback.enhancedForm.page3.lookToWorkspace.label') }}
								</label>
								<div>
									<label
										class="form__controls-label"
								...
								<label for="searchToolsDetailed" class="form__controls-question">
									{{
										$tc('feedback.enhancedForm.page3.searchToolsDetailed.label')
									}}
								</label>
								...
								<label for="iDoNotNeedVideoTut" class="form__controls-question">
									{{
										$tc('feedback.enhancedForm.page3.iDoNotNeedVideoTut.label')
									}}
								</label>
								...
								<label for="adequatelyDescribed" class="form__controls-question">
									{{
										$tc('feedback.enhancedForm.page3.adequatelyDescribed.label')
									}}
								</label>
								...
								<label for="portalSpeed" class="form__controls-question">
									{{ $tc('feedback.enhancedForm.page3.portalSpeed.label') }}
								</label>
						...
						<slide>
							<div class="slide-content">
								<div class="form__questions">
									<h3 class="form__questions-title">
										{{ $tc('feedback.enhancedForm.page4.title') }}
									</h3>
									<p class="form__questions-description">
										{{ $tc('feedback.enhancedForm.page4.description') }}
									</p>
								</div>

								<label for="usePortalFrequently" class="form__controls-question">
									{{
										$tc('feedback.enhancedForm.page4.usePortalFrequently.label')
									}}
								</label>
								...
								<label for="unnecessarilyComplex" class="form__controls-question">
									{{
										$tc('feedback.enhancedForm.page4.unnecessarilyComplex.label')
									}}
								</label>
								...
								<label for="easyToUse" class="form__controls-question">
									{{ $tc('feedback.enhancedForm.page4.easyToUse.label') }}
								</label>
								...
								<label for="needSupport" class="form__controls-question">
									{{ $tc('feedback.enhancedForm.page4.needSupport.label') }}
								</label>
								...
								<label for="tooMuchInconsistency" class="form__controls-question">
									{{
										$tc('feedback.enhancedForm.page4.tooMuchInconsistency.label')
									}}
								</label>
								...
								<label for="learnQuickly" class="form__controls-question">
									{{ $tc('feedback.enhancedForm.page4.learnQuickly.label') }}
								</label>
								...
								<label for="cumbersomeToUse" class="form__controls-question">
									{{ $tc('feedback.enhancedForm.page4.cumbersomeToUse.label') }}
								</label>
								...
								<label for="feltConfident" class="form__controls-question">
									{{ $tc('feedback.enhancedForm.page4.feltConfident.label') }}
								</label>
								...
								<label for="neededToLearn" class="form__controls-question">
									{{ $tc('feedback.enhancedForm.page4.neededToLearn.label') }}
								</label>
						...
						<slide>
							<div class="slide-content">
								<label for="portalFeature" class="form__controls-question not-required">
									{{ $tc('feedback.enhancedForm.page5.portalFeature.label') }}
								</label>
								<input
									type="text"
									class="form__controls-text-input"
								...
								<label for="whichFeatures" class="form__controls-question not-required">
									{{ $tc('feedback.enhancedForm.page5.whichFeatures.label') }}
								</label>
								<input
									type="text"
									class="form__controls-text-input"
								...
								<label for="suggestions" class="form__controls-question not-required">
									{{ $tc('feedback.enhancedForm.page5.suggestions.label') }}
								</label>
								<input
									type="text"
									class="form__controls-text-input"
								...
								<label for="wouldReturn" class="form__controls-question">
									{{ $tc('feedback.enhancedForm.page5.wouldReturn.label') }}
								</label>
								<div>
									<label
										class="form__controls-label"
								...
								<label for="leaveQuote" class="form__controls-question not-required">
									{{ $tc('feedback.enhancedForm.page5.leaveQuote.label') }}
								</label>
								<input
									type="text"
									class="form__controls-text-input"
