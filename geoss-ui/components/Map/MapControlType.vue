<template>
	<div class="map-control-type">
		<button class="map-control-type__trigger disabled-transparent" :class="{active: showSlider}" :title="$t('mapControls.changeBasemap')"
				:disabled="disabled" v-click-outside="{fn: closeSlider, excludeSelectors: '.map-control-type__slider-wrapper'}" @click="toggleSlider()">
