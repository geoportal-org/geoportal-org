<template>
	<div class="map-controls">
		...
		<MapControlLayers data-tutorial-tag="map-control-layers" class="map-control map-control__layers" :class="{'disable-container': generalFiltersInChange}"
				:disabled="isExtendedViewActive" />
		<!-- <MapControlType data-tutorial-tag="map-control-basemap" v-if="!isWidget" class="map-control map-control__type" :class="{'disable-container': generalFiltersInChange}"
				:disabled="isExtendedViewActive" /> -->
		<button data-tutorial-tag="map-control-toggle-search" class="map-control map-control__toggle-search-container disabled-transparent" @click="toggleSearchContainer()" :title="$t('searchBar.showHideAllMap')"
				:disabled="isExtendedViewActive">
			<i class="icomoon-minimize" v-show="!showFullMap"></i>
			<i class="icomoon-fullscreen" v-show="showFullMap"></i>
		</button>
		<FileDownloadNotifier data-tutorial-tag="map-control-download-file" class="file-download-notifier" :class="{'disable-container': generalFiltersInChange}"
				:disabled="isExtendedViewActive"/>
		<BulkDownloadNotifier data-tutorial-tag="map-control-download-bulk" class="bulk-download-notifier" :class="{'disable-container': generalFiltersInChange}"
				:disabled="isExtendedViewActive"/>
	</div>
</template>
