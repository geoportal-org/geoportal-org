<template>
	<div class="map-attribution" v-if="attributionDetails" :class="'map-attribution-' + attributionType">
		<a :href="attributionDetails.href" :target="attributionDetails.target" :class="'attribution-logo-' + attributionType">
			<img :alt="attributionDetails.alt" :src="`${staticPath()}/img/${attributionDetails.icon}`" :title="attributionDetails.title">
		</a>
...
export default class MapAttributionComponent extends Vue {
	...
	private mapAttributionsAssignment = {
		osm: 'osm',
		addsat: 'mapbox',
		mb_hybrid: 'mapbox',
		addhyb: 'mapbox',
