<template>
    <div v-if="showComponent" class="data-sources" :class="{ side: searchResultsActive }">
        <button data-tutorial-tag="search-container-datasource-data" class="data-sources__item disabled-transparent"
            :disabled="workflow || !anyResultFromDataTabAvailable" v-show="searchResultsActive && !dataTabHidden"
            @click="selectDataSource(DataSources.DAB)" :class="{
                active: activeTab === 'data',
                'loading-source': loading
            }">
            <i class="icomoon-data-source--data"></i>
            <span>{{ $tc('dataSources.dab') }}</span>
            <img class="tab_spinner" :src="`/img/spinner.png`" alt="Spinner" />
        </button>
        <button data-tutorial-tag="search-container-datasource-information" class="data-sources__item disabled-transparent"
            v-show="searchResultsActive && !informationTabHidden"
            :disabled="workflow || !anyResultFromInformationTabAvailable" @click="selectDataSource(DataSources.INFORMATION)"
            :class="{
                active: activeTab === 'information',
                'loading-source': loading
            }">
            <i class="icomoon-data-source--information"></i>
            <span>{{ $tc('dataSources.information') }}</span>
            <img class="tab_spinner" :src="`/img/spinner.png`" alt="Spinner" />
        </button>
        <button data-tutorial-tag="search-container-datasource-services" class="data-sources__item disabled-transparent"
            v-show="searchResultsActive && !servicesTabHidden" :disabled="workflow || !anyResultFromServicesTabAvailable"
            @click="selectDataSource(DataSources.SERVICES)" :class="{
                active: activeTab === 'services',
                'loading-source': loading
            }">
            <i class="icomoon-data-source--services"></i>
            <span>{{ $tc('dataSources.services') }}</span>
            <img class="tab_spinner" :src="`/img/spinner.png`" alt="Spinner" />
        </button>
    </div>
</template>
