<template>
	<div>
		<input :value="generalFiltersGeossDataCore" @input="input($event)" id="geoss-data-core" type="checkbox" :disabled="buttonDisabled" />
		<label for="geoss-data-core" :class="{disabled: buttonDisabled}">
			...
			<img :src="`${staticPath()}/img/geoss-data-core.png`" alt="Data Core" />
		</label>
	</div>
</template>
