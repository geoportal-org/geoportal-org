<template>
	<div class="custom-download">
		...
		<div class="custom-download__params">
			...
			<div class="custom-download__param">
				<label :title="$t('customDownloadOptionsPopup.scaleFactor')" class="custom-download__param-title">{{$t('customDownloadOptionsPopup.scaleFactor')}}:</label>
			...
			<div class="custom-download__param">
				<label :title="$t('customDownloadOptionsPopup.rangeSubset')" class="custom-download__param-title">{{$t('customDownloadOptionsPopup.rangeSubset')}}:</label>
				...
				<!-- <CustomSelect
					...
					:placeholder="$t('customDownloadOptionsPopup.none')" /> -->
			</div>
			<div class="custom-download__param">
				<label :title="$t('customDownloadOptionsPopup.crs')" class="custom-download__param-title">{{$t('customDownloadOptionsPopup.crs')}}:</label>
				<CustomSelect
					class="custom-download__param-select"
					v-model="outputCRS"
					:clearable="false"
					:options="options.outputCRS" 
					:placeholder="$t('customDownloadOptionsPopup.default')" />
			</div>
			<div class="custom-download__param">
				<label :title="$t('customDownloadOptionsPopup.coordinatesLowerCorner')" class="custom-download__param-title">{{$t('customDownloadOptionsPopup.coordinatesLowerCorner')}}:</label>
			...
			<div class="custom-download__param">
				<label :title="$t('customDownloadOptionsPopup.coordinatesUpperCorner')" class="custom-download__param-title">{{$t('customDownloadOptionsPopup.coordinatesUpperCorner')}}:</label>
				<div class="custom-download__param-sub coordinates">
		...
		<div class="text-center margin-top-30">
			<button v-if="!isBulkDownloadEnabled" class="green-btn-default" @click="download()">{{$t('customDownloadOptionsPopup.download')}}</button>
