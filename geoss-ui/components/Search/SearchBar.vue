<template>
    <div
        class="search-bar"
        :class="{ 'share-mode': showShare }"
        data-tutorial-tag="searchbar"
    >
        ...
        <button
            ...
            @click="search()"
            :disabled="
                (!generalFiltersNotEmpty && phrase === '') || !dataSource
            "
        ...
        <button
            ...
            @click="openShare()"
            :title="$tc('searchBar.shareSearch')"
        >
        ...
        <div class="search-bar__share" :class="{ active: showShare }">
            <div
                class="search-bar__share-wrapper"
                v-click-outside="{
                    fn: closeShare,
                    excludeSelectors: '.search-bar__share-trigger',
                }"
            >
                ...
                <button
                    class="close-btn"
                    @click="closeShare()"
                    :title="$tc('general.close')"
                    :aria-label="$tc('general.close')"
                ></button>
            </div>
        </div>
        <div
    ...
    public search(event?: KeyboardEvent) {
        if ((this.generalFiltersNotEmpty || this.phrase) && this.dataSource) {
            ...
            if (
                ...
                // this.$store.dispatch(InSituFiltersActions.reset)
