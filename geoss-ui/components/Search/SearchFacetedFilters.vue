<template>
    <div class="faceted-filters filters">
        <div class="faceted-filters__filters-hide" v-show="!anyFilterAvailable">
            {{ $tc('general.noFiltersAvailable') }}
        </div>
        <div class="faceted-filters__wrapper" v-show="anyFilterAvailable">
            <CustomSelect
                ...
                :filterable="true"
                :placeholder="$tc('facetedFilters.keyword')"
            ...
            <CustomSelect
                ...
                :filterable="true"
                :placeholder="$tc('facetedFilters.format')"
                :appendToBody="appendToBody"
            ...
            <CustomSelect
                ...
                :filterable="true"
                :placeholder="$tc('facetedFilters.source')"
                :appendToBody="appendToBody"
            ...
            <CustomSelect
                ...
                :filterable="true"
                :placeholder="$tc('facetedFilters.protocol')"
                :appendToBody="appendToBody"
            ...
            <CustomSelect
                ...
                :filterable="true"
                :placeholder="$tc('facetedFilters.organisation')"
                :appendToBody="appendToBody"
            ...
            <CustomSelect
                ...
                :filterable="true"
                :placeholder="$tc('facetedFilters.serviceHealth')"
                :appendToBody="appendToBody"
...
export default class SearchFacetedFiltersComponent extends Vue {
        ...
        if (this.currentResults && this.currentResults['dm:termFrequency']) {
            ...
            if (filterOptionsRaw && filterOptionsRaw[`dm:item`]) {
                ...
                for (const item of filterOptionsRaw[`dm:item`]) {
                    let name = ''
                    if (typeof item['dm:decodedTerm'] !== 'string') {
                        name = ''
                    } else {
                        name = item['dm:decodedTerm'] || ''
                    }
    ...
    private async onCurrentResultsChanged() {
        this.updateFilterOptions(
            FacetedFiltersActions.setKeywordOptions,
            'keyword'
        )
        this.updateFilterOptions(
            FacetedFiltersActions.setFormatOptions,
            'format'
        )
        this.updateFilterOptions(
            FacetedFiltersActions.setSourceOptions,
            'source'
        )
        this.updateFilterOptions(
            FacetedFiltersActions.setProtocolOptions,
            'protocol'
        )
        this.updateFilterOptions(
            FacetedFiltersActions.setOrganisationOptions,
            'organisationName'
        )
        this.updateFilterOptions(
            FacetedFiltersActions.setScoreOptions,
            'sscScore'
        )
        ...
        this.updateFilterValues(
            FacetedFiltersActions.setOrganisation,
            'organisationName'
        )
