<template>
    <div class="granula-filters filters">
        <div class="granula-filters__wrapper">
            <CustomSelect v-show="productTypeOptions.length" class="granula-filters__filter" v-model="productType"
                :options="productTypeOptions" :filterable="true" :placeholder="$tc('granulaFilters.productType')"
                :appendToBody="appendToBody" data-tutorial-tag="filters-granula-product-type" />
            <CustomSelect v-show="sensorPolarisationOptions.length" class="granula-filters__filter"
                v-model="sensorPolarisation" :options="sensorPolarisationOptions" :filterable="true"
                :placeholder="$tc('granulaFilters.sensorPolarisation')" :appendToBody="appendToBody"
                data-tutorial-tag="filters-granula-sensor-polarisation" />
            <CustomSelect v-show="sensorModeOptions.length" class="granula-filters__filter" v-model="sensorMode"
                :options="sensorModeOptions" :filterable="true" :placeholder="$tc('granulaFilters.sensorMode')"
                :appendToBody="appendToBody" data-tutorial-tag="filters-granula-sensor-mode" />
            <CustomSelect v-show="sensorSwathOptions.length" class="granula-filters__filter" v-model="sensorSwath"
                :options="sensorSwathOptions" :filterable="true" :placeholder="$tc('granulaFilters.sensorSwatch')"
                :appendToBody="appendToBody" data-tutorial-tag="filters-granula-sensor-swath" />
            <CustomSelect v-show="instrumentOptions.length" class="granula-filters__filter" v-model="instrument"
                :options="instrumentOptions" :filterable="true" :placeholder="$tc('granulaFilters.instrument')"
                :appendToBody="appendToBody" data-tutorial-tag="filters-granula-instrument" />
            <CustomSelect v-show="productLevelOptions.length" class="granula-filters__filter" v-model="productLevel"
                :options="productLevelOptions" :filterable="true" :placeholder="$tc('granulaFilters.productLevel')"
                :appendToBody="appendToBody" data-tutorial-tag="filters-granula-product-level" />
            <CustomSelect v-show="timelinessOptions.length" class="granula-filters__filter" v-model="timeliness"
                :options="timelinessOptions" :filterable="true" :placeholder="$tc('granulaFilters.timeliness')"
                :appendToBody="appendToBody" data-tutorial-tag="filters-granula-timeliness" />
            <input class="granula-filters__filter input" type="number" :value="relativeOrbit"
