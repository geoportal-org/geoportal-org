    ...
    <div class="workflow">
        <div class="workflow__top">
            ...
            <div class="d-flex flex--align-center flex--justify-end flex--1">
                <button class="workflow__action cancel" @click="cancel()">{{ $tc('popupContent.cancel') }}</button>
                <button class="workflow__action" @click="accept()">{{ $tc('popupContent.accept') }}</button>
            </div>
        </div>
    </div>
</template>
