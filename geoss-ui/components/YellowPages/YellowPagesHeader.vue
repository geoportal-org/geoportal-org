<template>
    <div class="yellow-pages-header">
        <div class="yellow-pages-header__title">{{ $tc('yellowPages.title') }}</div>
        <div class="yellow-pages-header__search">
            <input type="text" v-model="search" :placeholder="$tc('yellowPages.placeholderSearch')" />
        </div>
        <div class="yellow-pages-header__order-by">
            <div class="yellow-pages-header__order-by-title">{{ $tc('yellowPages.orderBy') }}</div>
            <CustomSelect class="yellow-pages-header__order-by-filter" v-model="orderBy" :appendToBody="false"
                :options="orderByOptions" :clearable="false" />
        </div>
        <nuxt-link to="/">
...
export default class YellowPagesHeader extends Vue {
    ...
    get orderByOptions() {
        return [
            { id: 'asc', text: this.$tc('yellowPages.nameAscending') },
            { id: 'desc', text: this.$tc('yellowPages.nameDescending') },
            { id: 'date', text: this.$tc('yellowPages.registrationDate') }
        ];
    }
