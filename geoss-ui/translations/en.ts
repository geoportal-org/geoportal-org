export default {
    ...
    notifications: {
        ...
        newVersionPart1: 'The GEOSS Portal has been updated for a more intuitive and fluid user experience.',
    ...
    welcomePopup: {
        ...
        newVersionPart1: 'The GEOSS Portal has been updated for a more intuitive and fluid user experience.',
        newVersionPart2: 'A Quick Tour video clip of the main features is available',
        newVersionPart3: 'here',
        newVersionPart4: 'Visit the',
        newVersionPart5: 'Release notes',
        newVersionPart6: 'to look at the detailed changes.'
    ...
    general: {
        ...
        loadingResourcesIsTakingTooLong: 'Resource loading takes more time than usual.',
        noResourcesFound: 'No resources found',
        noResourcesFoundChooseAnotherSource: 'No resources have been found for this type of data. Please choose to view resources from another type or go back to previous results',
    ...
    errors: {
        noMetadata: 'There was a problem with getting the metadata of the resource',
        google: {
            OVER_QUERY_LIMIT: 'Sorry, we are not able to translate into geographical terms your request right now. Try tomorrow.'
        }
    },
    map: {
        legend: 'Legend',
        ...
        compareLayer: 'Compare layers (at least 2 layers must be added and visible)'
    },
    searchBar: {
        filters: 'Filters',
        search: 'Search',
    ...
    generalFilters: {
        ...
        continentCountry: 'Continent & country list',
    ...
    customDownloadOptionsPopup: {
        ...
        download: 'Request a download',
        addToDownloads: 'Add to bulk download',
        outputDownloadFormat: 'Output download format',
        imageResolutionInPixels: 'Image resolution in pixels (250, 500)',
        coordinateReferenceSystemOfSubset: 'Coordinate Reference System of a subset',
        subsetLowerCoordinateInSpecifiedCRSFormat: 'Subset lower left coordinate in specified CRS format',
        subsetUpperCoordinateInSpecifiedCRSFormat: 'Subset upper right coordinate in specified CRS format',
        latLongRule: 'Allowed latitude values: between -90 and 90 and for longitude: between -180 and 180',
    ...
    dabResult: {
        ...
        thereAreNoRelatedResources: 'There are no related resources for this item',
        ...
        thisOptionAvailableForSignedIn: 'This option is available only to logged-in users.'
    },
    popupTitles: {
        ...
        downloadsList: 'Bulk download & Download list',
    ...
    popupContent: {
        addedToDownloadList: 'The resource has been added to your Download list. <a href="" class="openBulkDownloadPopup"><b>View the list</b></a>',
        addedCustomToDownloadList: 'The download request has been added to your Download list. <a href="" class="openBulkDownloadPopup"><b>View the list</b></a>',
        bookmarkSavedSuccess: 'Result has been saved in My Workspace -> Bookmarked Results.',
        ...
        saveSearchSuccess: 'Your search has been saved in My Workspace -> Your saved searches.',
        ...
        entryRelationsStart: 'You are now in ENTRY RELATIONS setting mode.<br />At first, please choose desired entry as a <b>relation source</b>.',
        ...
        dashboardBasedOn: 'Dashboard based on',
        preview: 'Preview',
        ...
        dragAndDropDescription: 'Drag and drop elements from the Toolbar<br/>to start creating a dashboard',
        loadingData: 'Loading data',
        noDashboardsAvailable: 'No dashboards available',
        dashboardInPreview: 'You are exploring dashboard in preview mode. To modify or save data, please',
        closePreview: 'close preview',
        goBackToCreator: 'and go back to creator',
        showAs: 'Show as',
        values: 'Values',
        percentage: 'Percentage',
        creatorCloseConfirmation: 'Are you sure you want to close the Dashboard Creator? All progress will be lost!',
        pageOrder: 'Page order',
        changePageOrder: 'Change page order',
        dragAndDropPageIcons: 'Drag and drop page icons to change its order',
        page: 'Page',
        of: 'of',
        save: 'Save',
        ...
        // confirm search
        lookingForResultInLocation: 'Are you looking for any result in location',
        ...
        // layer not available
        mapLayerUnavailable: 'Map service is not available at the moment. Portal maintenance team has been informed.\nWould you like to disable presentation of this layer?',
        ...
        runName: 'Run name',
        worldwide: 'Worldwide',
        serverResponseTimeout: 'Server response takes longer than expected - please try again.',
        ...
        improveDefinitionSuccess: 'Definition improvement was successfully sent to moderator',
        improveDefinitionFail: 'Failed to send definition improvement',
        improveTheResourceDefinition: 'Improve the resource definition',
        youNeedToBeSignedInToImprove: 'You need to be signed in to improve the resource definition',
        ...
        userContributedTitleTransferOptions: 'User contributed online resources',
        userContributedTitleComment: 'User comments',
        userContributedRemoveEntryExtension: 'Remove entry extension',
        userContributedAreYouSure: 'Are you sure you want to remove following entry extension?',
    ...
    fileDownloadsPopup: {
        ...
        downloadPackageWithoutThisFiles: 'download package without this file(s)',
        abort: 'abort',
        or: 'or',
        retry: 'retry',
        packagePreparation: 'package preparation.',
        requestTakesLongerThanExpected: 'Request takes longer than expected...',
        bulkDownloadPackageCreation: 'Bulk download package creation'
    },
    ...
    survey: {
        ...
        adequately: {
            title: 'How strongly do you agree with the following statement?',
            question: 'I think that the information offered on the site is adequately described',
            stronglyAgree: 'Strongly\nagree',
            stronglyDisagree: 'Strongly\ndisagree'
        },
        search_criteria: {
            question: 'Are there any other search criteria that would be helpful to you?',
            placeholder: 'Please write them here'
        },
        visualization: {
            question: 'Are there any visualizations of data that might help you better understand what can be derived from the Portal?',
    ...
    yellowPages: {
        ...
        biodiversity_and_ecosystem_sustainability: 'Biodiversity and Ecosystem Sustainability',
        disaster_resilience: 'Disaster Resilience',
        energy_and_mineral_resource_management: 'Energy and Mineral Resource Management',
        food_security_and_sustainable_agriculture: 'Food Security and Sustainable Agriculture',
        infrastructure_and_transportation_management: 'Infrastructure and Transportation Management',
    ...
    bookmarks: {
        ...
        desiredSource: 'You can show on map items of one data source only. Choose your desired data source:',
    ...
    feedback: {
        title: 'Send Feedback',
        email: 'Email',
        simpleOrEnhanced: 'Would like to fill-in the Simple or Enhanced GEOSS user questionnaire?',
        start: 'Start',
        submit: 'Submit',
        clear: 'Clear form',
        feedback: 'Feedback',
        ...
        nextPage: 'Next',
        other: 'Other',
        thankYou: 'The Questionnaire has been submitted. Thank you for your time!',
        simpleForm: {
        ...
        enhancedForm: {
            ...
            page1: {
                ...
                description: 'The GEOSS Portal User Questionnaire has been conceived to conduct a user assessment of the GEOSS Portal. The goal is to introduce users to the portal and evaluate the performance and capabilities of the portal interface.',
                descriptionCd: 'This questionnaire will provide the users’ perspective in three main areas of the GEOSS Portal:',
                ...
                measure: 'We would like to measure several different usability aspects:',
                ...
                qShouldBe: 'The questionnaire should be a living experience, so go ahead and open two tabs in your browser: one pointing to this questionnaire and the other on the actual portal (geoportal.org).',
                estimate: 'The estimated time to fulfill this survey is about 20 minutes.',
                thankYou: 'We thank you very much in advance for your time and contribution towards making this portal user-centric.',
                email: 'E-Mail Address'
            },
            page2: {
                title: 'ENTRY QUESTIONS – About You',
                description: 'The Entry Questions help us to determine who the end users are, what are their interests and if they have used this Portal already',
                interest: {
            ...
            page3: {
                ...
                description: 'The Operational Questions give us an idea of the user’s experience of the GEOSS Portal, the overall organization and content, its navigational capabilities and functionalities',
                goTo: {
            ...
            page4: {
                ...
                description: 'You are now confronted with statements to which you rate your level of agreement on a five-point scale (from “Strongly disagree” to “Strongly agree”).',
                usePortalFrequently: {
