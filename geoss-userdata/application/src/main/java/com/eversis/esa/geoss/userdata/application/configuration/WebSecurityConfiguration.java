package com.eversis.esa.geoss.userdata.application.configuration;

import com.eversis.esa.geoss.userdata.application.configuration.oauth2.SecurityOauth2Properties;
...
public class WebSecurityConfiguration {
    ...
    SecurityFilterChain h2ConsoleSecurityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests().requestMatchers(PathRequest.toH2Console())
                .authenticated();
    ...
    SecurityFilterChain apiSecurityFilterChain(HttpSecurity http,
        ...
        http.authorizeHttpRequests()
                .requestMatchers(basePath + "/userdata/**").hasRole("USER")
