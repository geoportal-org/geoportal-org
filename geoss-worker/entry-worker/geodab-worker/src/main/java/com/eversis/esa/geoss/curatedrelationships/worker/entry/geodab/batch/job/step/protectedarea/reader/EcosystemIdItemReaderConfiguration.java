...
/**
 * The type Ecosystem id item reader configuration.
 */
@Configuration
class EcosystemIdItemReaderConfiguration {
    ...
    /**
     * Ecosystem id item reader jdbc paging item reader.
     *
    ...
    JdbcPagingItemReader<String> ecosystemIdItemReader(
        ...
        parameterValues.put("ecosystemIdentifier", EntryIdentifiers.ECOSYSTEM);
