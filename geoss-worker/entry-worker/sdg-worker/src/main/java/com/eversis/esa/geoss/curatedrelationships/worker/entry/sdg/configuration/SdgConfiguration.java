 ...
 */
@OpenAPIDefinition(info = @Info(title = "OpenAPI definition", version = "v0", description = "GEOSS SDG worker API"))
@Configuration(proxyBeanMethods = false)
public class SdgConfiguration {

    /**
     * Sdg open api customizer open api customizer.
     *
     * @return the open api customizer
     */
    @Bean
    OpenApiCustomizer sdgOpenApiCustomizer() {
        return openApi -> {
