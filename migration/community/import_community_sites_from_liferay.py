...
def main():
    ...
    failed_data_file = os.path.join(failed_data_dir, COMMUNITY_SITES_FAILED_RECORDS_FILE)
    ...
    if failed_records:
        save_failed_records(failed_records, failed_data_dir, COMMUNITY_SITES_FAILED_RECORDS_FILE)
