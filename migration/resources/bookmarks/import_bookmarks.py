...
def main():
    ...
    failed_data_file = os.path.join(failed_data_dir, BOOKMARKS_FAILED_RECORDS_FILE)
    ...
    data = load_data(data_dir, BOOKMARKS_FILE)
    failed_records = process_records(data, keycloak_admin, admin_access_token, bookmarked_api_url)

    log_end_time(start_time)

    if failed_records:
        save_failed_records(failed_records, failed_data_dir, BOOKMARKS_FAILED_RECORDS_FILE)
