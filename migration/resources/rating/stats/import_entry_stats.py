...
def main():
    ...
    if os.path.exists(RESOURCE_RATING_STATS_FAILED_RECORDS_FILE):
        os.remove(RESOURCE_RATING_STATS_FAILED_RECORDS_FILE)
    ...
    data = load_data(RESOURCE_RATING_STATS_FILE)
    failed_records = process_records(data, admin_access_token, stats_api_url)

    log_end_time(start_time)

    if failed_records:
        save_failed_records(failed_records, RESOURCE_RATING_STATS_FAILED_RECORDS_FILE)
