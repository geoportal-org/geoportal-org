...
python community/import_community_sites_from_liferay.py sit_environment_config.ini
...
python settings/tutorialtags/import_tutorial_tags_from_liferay.py sit_environment_config.ini
echo 'Import tutorial tags from liferay ended'

echo 'Import default layers from liferay started'
python settings/layers/import_default_layers_from_liferay.py sit_environment_config.ini
echo 'Import default layers from liferay ended'

echo 'Import resource rating stats from liferay started'
python resources/rating/stats/import_entry_stats.py sit_environment_config.ini
echo 'Import resource rating stats from liferay ended'

echo 'Import resource rating entries from liferay started'
python resources/rating/entry/import_entry_rating.py sit_environment_config.ini
echo 'Import resource rating entries from liferay ended'

echo 'Import user accounts from liferay started'
python accounts/import_users_from_liferay.py sit_environment_config.ini
echo 'Import user accounts from liferay ended'

echo 'Import user settings from liferay started'
python personaldata/settings/import_users_settings_from_liferay.py sit_environment_config.ini
echo 'Import user settings from liferay ended'

echo 'Import saved searches from liferay started'
python personaldata/savedsearches/import_saved_searches_from_liferay.py sit_environment_config.ini
echo 'Import saved searches from liferay ended'

echo 'Import saved runs from liferay started'
python personaldata/savedruns/import_saved_runs_from_liferay.py sit_environment_config.ini
...
python surveys/import_surveys.py sit_environment_config.ini
